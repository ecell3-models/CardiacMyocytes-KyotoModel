...
System System( /CELL/GLYCOGENOLYSIS )
{
	...
	Variable Variable( KGLYf )
	{
		Value 1.7;
	}

	Variable Variable( KGLYb )
	{
		Value 0.15;
	}

	Variable Variable( KiGLYf )
	{
		Value 15.0;
	}

	Variable Variable( KiGLYb )
	{
		Value 4.4;
	}
	...
	Process ExpressionAssignmentProcess ( Vmaxr_GPa )
	{
		...
		Expression "( Vmaxf_GPa.Value * KGLYb.Value * KiG1P_GPa.Value ) / ( KiGLYf.Value * KPi_GPa.Value * KeqGP.Value )";		
	}
	...
	Process ExpressionAssignmentProcess ( V_GPa_assign )
	{
		...
		Expression "( Vmaxf_GPa.Value *  GLY.Value * Pi.Value /( KiGLYf.Value * KPi_GPa.Value ) -  Vmaxr_GPa.Value *  GLY.Value * G1P.Value  / ( KGLYb.Value * KiG1P_GPa.Value)) / ( 1.0 + GLY.Value / KiGLYf.Value + Pi.Value / KiPi_GPa.Value + GLY.Value / KiGLYb.Value + G1P.Value / KiG1P_GPa.Value + GLY.Value * Pi.Value / ( KGLYf.Value * KiPi_GPa.Value ) + GLY.Value * G1P.Value / ( KGLYb.Value * KiG1P_GPa.Value ))";		
	}
	...
	Process ExpressionAssignmentProcess ( Vmaxr_GPb )
	{
		...
		Expression "( Vmaxf_GPb.Value * KiGLYb.Value * KG1P_GPb.Value ) / ( KGLYf.Value * KiPi_GPb.Value * KeqGP.Value )";		
	}
	...
	Process ExpressionAssignmentProcess ( V_GPb_assign )
	{
		...
		Expression "( Vmaxf_GPb.Value * GLY.Value * Pi.Value / ( KiGLYf.Value * KPi_GPb.Value ) - Vmaxr_GPb.Value *  GLY.Value * G1P.Value / ( KiGLYb.Value * KG1P_GPb.Value )) / ( 1.0 + GLY.Value / KiGLYf.Value + Pi.Value / KiPi_GPb.Value + GLY.Value / KiGLYb.Value + G1P.Value / KiG1P_GPb.Value + GLY.Value * Pi.Value / ( KiGLYf.Value * KPi_GPb.Value ) + GLY.Value * G1P.Value / ( KiGLYb.Value * KG1P_GPb.Value )) * ( pow( AMP.Value, nH.Value ) / K_AMP.Value ) / ( 1.0 +( pow( AMP.Value, nH.Value ) / K_AMP.Value ))";		
	}
	...
	Variable Variable( fraxGP )
	{
		Value 0.0;
	}

	Variable Variable( GP )
	{
		Value 0.0;
	}

	Process ExpressionFluxProcess ( fluxGP )
	{
		StepperID  ODE;
		Priority   0;
...
#		Expression "( Vmaxr_CK.Value * ATP.Value * Cr.Value / ( KiATP_CK.Value * KCr.Value ) -  Vmaxf_CK.Value * ADP.Value * PCr.Value / ( KiADP.Value * KPCr.Value )) / ( 1.0 + ADP.Value / KiADP.Value + PCr.Value / KiPCr.Value + ADP.Value * PCr.Value / ( KiADP.Value * KPCr.Value ) + ATP.Value / KiATP_CK.Value + ATP.Value * Cr.Value / ( KiATP_CK.Value * KCr.Value ))";		
...
#		Expression "( Vmaxf_ADK.Value * ATP.Value * AMP.Value / ( KATP_ADK.Value * KAMP.Value ) -  Vmaxr_ADK.Value * pow( ADP.Value / KADP_ADK.Value, 2.0 )) / ( 1.0 + ATP.Value / KATP_ADK.Value + AMP.Value / KAMP.Value + ATP.Value * AMP.Value / ( KATP_ADK.Value * KAMP.Value ) + 2.0 * ADP.Value / KADP_ADK.Value + pow( ADP.Value / KADP_ADK.Value, 2.0 ))";		
#	}
...
#	}
	...
	Variable Variable( Kcombo )
	{
		Value 1.0;
	}

       Process ExpressionAssignmentProcess ( Kcombo )
        {
                StepperID  ODE;
                Priority   1;
                ...
                Expression "pow( LAC.Value, 2.0 ) * pow( ATP.Value / ( ADP.Value * Pi.Value ), 3.0 )";
        }
