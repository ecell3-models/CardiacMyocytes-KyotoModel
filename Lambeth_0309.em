...
#Amano_Differential_equations.em
	Process ExpressionAssignmentProcess ( G1P )
	{
	        StepperID  ODE;
		Priority   1;
			...
			[ V_PGLM   :.:Vmaxr_GPa    0 ];
                ...
                Expression " -flux_GP.Value - V_PGLM.Value ";
        }

        Process ExpressionAssignmentProcess ( G6P )
        {
                StepperID ODE;
                Priority  1;
                ...
                Expression " V_PGLM.Value - V_PGI.Value";
         }
	 ...
	 Process ExpressionAssignmentProcess ( F6P )
	 {
		 StepperID ODE;
			 ...
			 [ F6P	    :.:F6P	   1 ]
                 ...
                 Expression "V_PGI.Value - V_PFK.Value ";
         }

         Process ExpressionAssignmentProcess ( FBP )
         {
                 StepperID ODE;
                 Priority  1;
                 ...
                 Expression " V_PFK.Value - V_ALD.Value ";
         }          
        ...
        Process ExpressionAssignmentProcess ( DHAP )
        {
                ...
                Expression " V_ALD.Value + V_TPI.Value ";
        }

        Process ExpressionAssignmentProcess ( GAP )
        {
                StepperID  ODE;
                Priority   1;
                ...
                Expression " V_ALD.Value - V_TPI.Value - V_GAPDH.Value ";
        }

        Process ExpressionAssignmentProcess ( _13BPG )
        {
                StepperID  ODE;
                Priority   1;
                ...
                Expression " V_GAPDH.Value - V_PGK.Value ";

        }

        Process ExpressionAssignmentProcess ( _3PG )
        {
                StepperID  ODE;
                Priority   1;
                ...
                Expression " V_PGK.Value - V_PGM.Value ";

        }

        Process ExpressionAssignmentProcess ( _2PG )
        {
                StepperID  ODE;
                Priority   1;
                ...
                Expression " V_PGM.Value - V_EN.Value ";
       
        }

        Process ExpressionAssignmentProcess ( PEP )
        {
                StepperID  ODE;
                Priority   1;
                ...
                Expression " V_EN.Value - V_PK.Value ";

        }

        Process ExpressionAssignmentProcess ( PYR )
        {
                StepperID  ODE;
                Priority   1;
                ...
                Expression " V_PK.Value - V_LDH.Value ";

        }

        Process ExpressionAssignmentProcess ( LAC )
        {
                StepperID  ODE;
                Priority   0;
                ...
                Expression "V_LDH.Value - V_OUTPUT.Value";
        }
...
#                Expression "-flux_GP.Value - V_GAPDH.Value + V_ATPase.Value";
#        }

#        Process ExpressionAssignmentProcess ( ADP )
#        {
#                StepperID  ODE;
#                Priority   0;
...
#                Expression "V_PFK.Value - V_PGK.Value - V_PK.Value + 2.0 * V_ADK.Value + V_CK.Value + V_ATPase.Value";
#        }

#        Process ExpressionAssignmentProcess ( ATP )
#        {
#                StepperID  ODE;
#                Priority   0;
...
#                Expression "-V_PFK.Value + V_PGK.Value + V_PK.Value - V_ADK.Value - V_CK.Value - V_ATPase.Value";
#        }

        Process ExpressionAssignmentProcess ( PCr )
        {
                StepperID  ODE;
                Priority   0;
        ...
        Process ExpressionAssignmentProcess ( NAD )
        {
                ...
                Expression "-V_GAPDH.Value + V_LDH.Value";
        }
#Amano_Differential_equations.em
