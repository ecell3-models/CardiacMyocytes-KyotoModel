...
System System(/CELL/MEMBRANE/ICaL)
{
	...
	Process ICaLAssignmentProcess( I ) 
	{
		...
		#PKA_factor0       @( 1.0 - ICaL_MAX / ( 1.0 + pow( ICaL_KmPKA / PKA0, ICaL_hill_n )));
                ...
                permeabilityNa    @( ICaL_permeabilityCa[SimulationMode] * 0.0000185);
		permeabilityK     @( ICaL_permeabilityCa[SimulationMode] * 0.000365 );
	        permeabilityCa    @( ICaL_permeabilityCa[SimulationMode] );
