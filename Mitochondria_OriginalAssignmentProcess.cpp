...
LIBECS_DM_CLASS( Mitochondria_OriginalAssignmentProcess, Process )
{

 public:

	LIBECS_DM_OBJECT( Mitochondria_OriginalAssignmentProcess, Process )
	{
	...
	Mitochondria_OriginalAssignmentProcess()
		:
		//PiTotal( 46.0e-3 ),
...
LIBECS_DM_INIT( Mitochondria_OriginalAssignmentProcess, Process );
