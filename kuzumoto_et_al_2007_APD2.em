...
#Variables for APD
    ...
    Process ExpressionAssignmentProcess( t_stim )
    {
        ...
        VariableReferenceList
            [ t_stim :.:t_stim   1 ]
            [ I_stim :/Pipette:I 0 ];
        Expression "eq(I_stim.Value,-8000) * (t_stim.Value + 1/200) + neq(I_stim.Value,-8000) * t_stim.Value";
    }
    ...
    Process ExpressionAssignmentProcess( Max )
    {
        ...
        VariableReferenceList
            [ Max     :.:Max        1 ]
            [ Vm      :.:Vm         0 ];
        Expression "leq(Vm.Value,Max.Value) * Max.Value + gt(Vm.Value,Max.Value) * Vm.Value";
    }
    ...
    Process ExpressionAssignmentProcess( Min )
    {
        ...
        VariableReferenceList
            [ Min     :.:Min        1 ]
            [ Vm      :.:Vm         0 ];
        Expression "geq(Vm.Value,Min.Value) * Min.Value + lt(Vm.Value,Min.Value) * Vm.Value";                          
    }	
    ...
    Process ExpressionAssignmentProcess( APD_1 )
    {
        ...
        VariableReferenceList
            ...
            [ t_stim :.:t_stim 0 ]
            [ time   :/:t      0 ];
        Expression "and(geq(t_stim.Value,1),leq(Vm.Value,(Max.Value - Min.Value) * (1 - x) + Min.Value)) * time.Value + or(lt(t_stim.Value,1),gt(Vm.Value,(Max.Value - Min.Value) * (1 - x) + Min.Value)) * APD_1.Value";
    }
    ...
    Process ExpressionAssignmentProcess( APD )
    {
        ...
        VariableReferenceList
            ...
            [ time  :/:t     1 ]
            [ APD_1 :.:APD_1 0 ];
        Expression "neq(APD_1.Value,time.Value) * (time.Value - APD_1.Value) + eq(APD_1.Value,time.Value) * APD.Value";
    }
}
