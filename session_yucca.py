...
savefile = '/home/t12870hm/vicinity/' + str(currentnumber) + FullPN_GX + VALUE_OF_GX
os.mkdir(savefile)
...
'''
This function take dictionary {}L; as argument and return list [] which has FullPN of GX as elements.
