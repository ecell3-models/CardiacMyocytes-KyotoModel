...
#		Expression "VGPA_maxf * KGPA_GLYb * KGPA_iG1P / KGPA_iGLYf / KGPA_Pi / KGPA_eq";
		Expression "Vmaxf_GPa.Value * KGLYb_GPa.Value * KiG1P_GPa.Value / KiGLYf_GPa.Value / KPi_GPa.Value / KeqGP.Value";
	}
...
#		Expression "VGPA_maxf * (GLY.getValue() * Pi.getValue() / KGPA_iGLYf / KGPA_Pi ) - VGPA_maxr * (GLY.getValue() * G1P.getValue() / KGPA_GLYb / KGPA_iG1P)";	
		Expression "Vmaxf_GPa.Value * (GLY.Value * Pi.Value / KiGLYf_GPa.Value / KPi_GPa.Value ) - Vmaxr_GPa.Value * (GLY.Value * G1P.Value / KGLYb_GPa.Value / KiG1P_GPa.Value)";	
	}
...
#		Expression " 1 + GLY.getValue() / KGPA_iGLYf + Pi.getValue() / KGPA_iPi + GLY.getValue() / KGPA_iGLYb + G1P.getValue() / KGPA_iG1P + GLY.getValue() * Pi.getValue() / (KGPA_GLYf * KGPA_iPi) + GLY.getValue() * G1P.getValue() /(KGPA_GLYb * KGPA_iG1P)";
		Expression " 1.0 + GLY.Value / KiGLYf_GPa.Value + Pi.Value / KiPi_GPa.Value + GLY.Value / KiGLYb_GPa.Value + G1P.Value / KiG1P_GPa.Value + GLY.Value * Pi.Value / (KGLYf_GPa.Value * KiPi_GPa.Value) + GLY.Value * G1P.Value /(KGLYb_GPa.Value * KiG1P_GPa.Value)";
        }
...
#		Expression "VGPB_maxf * KGPB_iGLYb * KGPB_G1P / KGPB_iGLYf / KGPB_Pi / KGPB_eq";
		Expression "Vmaxf_GPb.Value * KiGLYb_GPb.Value * KG1P_GPb.Value / KiGLYf_GPb.Value / KPi_GPb.Value / KeqGP.Value";
	}
...
#		Expression "(Math.pow(AMP.getValue(), nH_GPB)/ KGPB_AMP) * (VGPB_maxf * (GLY.getValue() * Pi.getValue() /(KGPB_iGLYf * KGPB_Pi)) - VGPB_maxr * (GLY.getValue() * G1P.getValue()/(KGPB_iGLYb * KGPB_G1P)))";	
		Expression "(pow(AMP.Value, nH.Value)/ K_AMP.Value) * (Vmaxf_GPb.Value * (GLY.Value * Pi.Value /(KiGLYf_GPb.Value * KPi_GPb.Value)) - Vmaxr_GPb.Value * (GLY.Value * G1P.Value/(KiGLYb_GPb.Value * KG1P_GPb.Value)))";	
        }
...
#		Expression "(1 + Math.pow(AMP.getValue(), nH_GPB)/ KGPB_AMP) * ( 1 + GLY.getValue() / KGPB_iGLYf + Pi.getValue() / KGPB_iPi + GLY.getValue() / KGPB_iGLYb + G1P.getValue() / KGPB_iG1P + GLY.getValue() * Pi.getValue() / (KGPB_iGLYf * KGPB_Pi) + GLY.getValue() * G1P.getValue() /(KGPB_iGLYb * KGPB_G1P) )";
		Expression "(1.0 + pow(AMP.Value, nH.Value)/ K_AMP.Value) * ( 1.0 + GLY.Value / KiGLYf_GPb.Value + Pi.Value / KiPi_GPb.Value + GLY.Value / KiGLYb_GPb.Value + G1P.Value / KiG1P_GPb.Value + GLY.Value * Pi.Value / (KiGLYf_GPb.Value * KPi_GPb.Value) + GLY.Value * G1P.Value /(KiGLYb_GPb.Value * KG1P_GPb.Value))";
        }
...
#		Expression "frac_a.Value * V_GPa.Value + frac_b.Value * V_GPb.Value";
#		Expression "(frac_a.getValue() * V_GPA.getValue() + frac_b.getValue() * V_GPB.getValue())";
		Expression "(frac_a.Value * V_GPa.Value + frac_b.Value * V_GPb.Value)";
	}
...
#		Expression "VPGLM_maxf * KPGLM_G6P / KPGLM_G1P / KPGLM_eq";
		Expression "Vmaxf_PGLM.Value * KG6P_PGLM.Value / KG1P_PGLM.Value / KeqPGLM.Value";
	}
...
#		Expression "(VPGLM_maxf * G1P.getValue() / KPGLM_G1P - VPGLM_maxr * G6P.getValue() / KPGLM_G6P)/(1 + G1P.getValue() / KPGLM_G1P + G6P.getValue() / KPGLM_G6P)";
		Expression "(Vmaxf_PGLM.Value * G1P.Value / KG1P_PGLM.Value - Vmaxr_PGLM.Value * G6P.Value / KG6P_PGLM.Value)/(1.0 + G1P.Value / KG1P_PGLM.Value + G6P.Value / KG6P_PGLM.Value)";
	}
...
#		Expression "VPGI_maxr * KPGI_G6P * KPGI_eq / KPGI_F6P";
		Expression "Vmaxr_PGI.Value * KG6P_PGI.Value * KeqPGI.Value / KF6P_PGI.Value";
	}
...
#		Expression "(VPGI_maxf * G6P.getValue() / KPGI_G6P - VPGI_maxr * F6P.getValue() / KPGI_F6P)/(1 + G6P.getValue() / KPGI_G6P + F6P.getValue() / KPGI_F6P)";
		Expression "(Vmaxf_PGI.Value * G6P.Value / KG6P_PGI.Value - Vmaxr_PGI.Value * F6P.Value / KF6P_PGI.Value)/(1.0 + G6P.Value / KG6P_PGI.Value + F6P.Value / KF6P_PGI.Value)";
	}
...
#		Expression "(1 + F6P.getValue() / KPFK_F6P) * (1 + ATP.getValue() / KPFK_ATP)+ ADP.getValue() / KPFK_ADP + FBP.getValue() / KPFK_FBP * (1 + ADP.getValue() / KPFK_ADP)";
		Expression "(1.0 + F6P.Value / KF6P_PFK.Value) * (1.0 + ATP.Value / KATP_PFK.Value)+ ADP.Value / KADP_PFK.Value + FBP.Value / KFBP_PFK.Value * (1.0 + ADP.Value / KADP_PFK.Value)";
	}
...
#		Expression  "(1 + F6P.getValue() / KPFK_F6P2) * (1 + ATP.getValue() / KPFK_ATP2)+ ADP.getValue() / KPFK_ADP2 + FBP.getValue() / KPFK_FBP2 * (1 + ADP.getValue() / KPFK_ADP2)";
		Expression  "(1.0 + F6P.Value / K_F6P.Value) * (1.0 + ATP.Value / K_ATP.Value)+ ADP.Value / K_ADP.Value + FBP.Value / K_FBP.Value * (1.0 + ADP.Value / K_ADP.Value)";
	}
...
#		Expression " KPFK_F6P * KPFK_ATP / KPFK_F6P2 / KPFK_ATP2";
		Expression " KF6P_PFK.Value * KATP_PFK.Value / K_F6P.Value / K_ATP.Value";
	}
...
#		Expression "Lo_PFK * Math.pow(((1+ATP.getValue()/KPFK_iATP) / (1 + d_PFK * ATP.getValue()/KPFK_iATP)) * ((1 + e_PFK * AMP.getValue()/KPFK_aAMP) / (1 + AMP.getValue()/KPFK_aAMP)), 4)";
		Expression "L0.Value * pow(((1.0+ATP.Value/KiATP_PFK.Value) / (1.0 + d.Value * ATP.Value/KiATP_PFK.Value)) * ((1.0 + e.Value * AMP.Value/KaAMP.Value) / (1.0 + AMP.Value/KaAMP.Value)), 4.0)";
	}
...
#duck		Value 56.0;
        ...
        Variable Variable( KeqPFK ) #Aoki_add120313
        {
                Value 242.0;
        }
...
#		Expression "Vmaxf_PFK.Value * KADP_PFK.Value * KFBP_PFK.Value / KATP_PFK.Value / KF6P_PFK.Value / KeqPFK.Value ";
#		Expression  "VPFK_maxf * KPFK_ADP * KPFK_FBP / KPFK_ATP / KPFK_F6P / KPFK_eq";	
		Expression  "Vmaxf_PFK.Value * KADP_PFK.Value * KFBP_PFK.Value / KATP_PFK.Value / KF6P_PFK.Value / KeqPFK.Value";	
	}
...
#		Expression "((1 + alpha * L * Math.pow(delta2/delta1, 3))*(VPFK_maxf * ATP.getValue() * F6P.getValue() /(KPFK_ATP * KPFK_F6P) - VPFK_maxr * ADP.getValue() * FBP.getValue() /(KPFK_ADP * KPFK_FBP)))/(delta1 * (1 + L * Math.pow(delta2/delta1, 4)))";
		Expression "((1.0 + alpha.Value * L.Value * pow(delta_.Value/delta.Value, 3.0))*(Vmaxf_PFK.Value * ATP.Value * F6P.Value /(KATP_PFK.Value * KF6P_PFK.Value) - Vmaxr_PFK.Value * ADP.Value * FBP.Value /(KADP_PFK.Value * KFBP_PFK.Value)))/(delta.Value * (1.0 + L.Value * pow(delta_.Value/delta.Value, 4.0)))";
	}
...
#		Expression "VALD_maxf * KALD_DHAP * KALD_GAP / KALD_FBP / KALD_eq";
		Expression "Vmaxf_ALD.Value * KDHAP_ALD.Value * KGAP_ALD.Value / KFBP_ALD.Value / KeqALD.Value";
	}
...
#		Expression "(VALD_maxf * FBP.getValue() / KALD_FBP - VALD_maxr * DHAP.getValue() * GAP.getValue() / (KALD_DHAP * KALD_GAP))/(1 + FBP.getValue() / KALD_FBP + DHAP.getValue() / KALD_DHAP + GAP.getValue() / KALD_GAP)";
		Expression "(Vmaxf_ALD.Value * FBP.Value / KFBP_ALD.Value - Vmaxr_ALD.Value * DHAP.Value * GAP.Value / (KDHAP_ALD.Value * KGAP_ALD.Value))/(1.0 + FBP.Value / KFBP_ALD.Value + DHAP.Value / KDHAP_ALD.Value + GAP.Value / KGAP_ALD.Value)";
	}
...
#		Expression " VTPI_maxf * KTPI_DHAP / KTPI_GAP / KTPI_eq";
		Expression " Vmaxf_TPI.Value * KDHAP_TPI.Value / KGAP_TPI.Value / KeqTPI.Value";
	}
...
#		Expression "(VTPI_maxf * GAP.getValue() / KTPI_GAP - VTPI_maxr * DHAP.getValue() / KTPI_DHAP)/(1 + GAP.getValue() /KTPI_GAP + DHAP.getValue() / KTPI_DHAP)";
		Expression "(Vmaxf_TPI.Value * GAP.Value / KGAP_TPI.Value - Vmaxr_TPI.Value * DHAP.Value / KDHAP_TPI.Value)/(1.0 + GAP.Value /KGAP_TPI.Value + DHAP.Value / KDHAP_TPI.Value)";
	}
...
#		Expression "1 + GAP.getValue() / KGAPDH_GAP + NAD.getValue() / KGAPDH_NAD + Pi.getValue() / KGAPDH_Pi + GAP.getValue() * NAD.getValue() / (KGAPDH_GAP * KGAPDH_NAD) + GAP.getValue() * NAD.getValue() * Pi.getValue() / (KGAPDH_GAP * KGAPDH_NAD * KGAPDH_Pi) + BPG13.getValue() / KGAPDH_13BPG + NADH.getValue() / KGAPDH_NADH + BPG13.getValue() * NADH.getValue()/(KGAPDH_13BPG * KGAPDH_NADH)";
		Expression "1.0 + GAP.Value / KGAP_GAPDH.Value + NAD.Value / KNAD_GAPDH.Value + Pi.Value / KPi_GAPDH.Value + GAP.Value * NAD.Value / (KGAP_GAPDH.Value * KNAD_GAPDH.Value) + GAP.Value * NAD.Value * Pi.Value / (KGAP_GAPDH.Value * KNAD_GAPDH.Value * KPi_GAPDH.Value) + x13BPG.Value / K13BPG_GAPDH.Value + NADH.Value / KNADH_GAPDH.Value + x13BPG.Value * NADH.Value/(K13BPG_GAPDH.Value * KNADH_GAPDH.Value)";
	}
...
#		Expression "VGAPDH_maxf * KGAPDH_13BPG * KGAPDH_NADH / KGAPDH_GAP / KGAPDH_NAD / KGAPDH_Pi / KGAPDH_eq";		
		Expression "Vmaxf_GAPDH.Value * K13BPG_GAPDH.Value * KNADH_GAPDH.Value / KGAP_GAPDH.Value / KNAD_GAPDH.Value / KPi_GAPDH.Value / KeqGAPDH.Value";		
	}
...
#		Expression "VGAPDH_maxf * GAP.getValue() * NAD.getValue() * Pi.getValue() / (KGAPDH_GAP * KGAPDH_NAD * KGAPDH_Pi) - VGAPDH_maxr * BPG13.getValue() * NADH.getValue() / (KGAPDH_13BPG * KGAPDH_NADH)/ D_GAPDH.Value";	
		Expression "(Vmaxf_GAPDH.Value * GAP.Value * NAD.Value * Pi.Value / (KGAP_GAPDH.Value * KNAD_GAPDH.Value * KPi_GAPDH.Value) - Vmaxr_GAPDH.Value * x13BPG.Value * NADH.Value / (K13BPG_GAPDH.Value * KNADH_GAPDH.Value)) / D_GAPDH.Value";	
	}
...
#		Expression "VPGK_maxr * KPGK_13BPG * KPGK_ADP * KPGK_eq / KPGK_3PG / KPGK_ATP";
		Expression "Vmaxr_PGK.Value * K13BPG_PGK.Value * KADP_PGK.Value * KeqPGK.Value / K3PG_PGK.Value / KATP_PGK.Value";
	}
...
#		Expression "(VPGK_maxf * BPG13.getValue() * ADP.getValue() / (KPGK_13BPG * KPGK_ADP) - VPGK_maxr * PG3.getValue() * ATP.getValue() / (KPGK_3PG * KPGK_ATP))/(1 + BPG13.getValue() / KPGK_13BPG + ADP.getValue() / KPGK_ADP + BPG13.getValue() * ADP.getValue() / (KPGK_13BPG * KPGK_ADP) + PG3.getValue() / KPGK_3PG + ATP.getValue() / KPGK_ATP + PG3.getValue() * ATP.getValue() / (KPGK_3PG * KPGK_ATP))";
		Expression "(Vmaxf_PGK.Value * x13BPG.Value * ADP.Value / (K13BPG_PGK.Value * KADP_PGK.Value) - Vmaxr_PGK.Value * x3PG.Value * ATP.Value / (K3PG_PGK.Value * KATP_PGK.Value))/(1.0 + x13BPG.Value / K13BPG_PGK.Value + ADP.Value / KADP_PGK.Value + x13BPG.Value * ADP.Value / (K13BPG_PGK.Value * KADP_PGK.Value) + x3PG.Value / K3PG_PGK.Value + ATP.Value / KATP_PGK.Value + x3PG.Value * ATP.Value / (K3PG_PGK.Value * KATP_PGK.Value))";
	}
...
#		Expression "VPGM_maxf * KPGM_2PG / KPGM_3PG / KPGM_eq";
		Expression "Vmaxf_PGM.Value * K2PG_PGM.Value / K3PG_PGM.Value / KeqPGM.Value";
	}
...
#		Expression "(VPGM_maxf * PG3.getValue() / KPGM_3PG - VPGM_maxr * PG2.getValue() / KPGM_2PG)/(1 + PG3.getValue() / KPGM_3PG + PG2.getValue() / KPGM_2PG)";
		Expression "(Vmaxf_PGM.Value * x3PG.Value / K3PG_PGM.Value - Vmaxr_PGM.Value * x2PG.Value / K2PG_PGM.Value)/(1.0 + x3PG.Value / K3PG_PGM.Value + x2PG.Value / K2PG_PGM.Value)";
	}
...
#		Expression "VEN_maxf * KEN_PEP / KEN_2PG / KEN_eq";
		Expression "Vmaxf_EN.Value * KPEP_EN.Value / K2PG_EN.Value / KeqEN.Value";
	}
...
#		Expression "(VEN_maxf * PG2.getValue() / KEN_2PG - VEN_maxr * PEP.getValue() / KEN_PEP)/(1 + PG2.getValue() / KEN_2PG + PEP.getValue() / KEN_PEP)";
		Expression "(Vmaxf_EN.Value * x2PG.Value / K2PG_EN.Value - Vmaxr_EN.Value * PEP.Value / KPEP_EN.Value)/(1.0 + x2PG.Value / K2PG_EN.Value + PEP.Value / KPEP_EN.Value)";
	}
...
#		Expression "VPK_maxf * KPK_ATP * KPK_PYR / KPK_PEP / KPK_ADP / KPK_eq";
		Expression "Vmaxf_PK.Value * KATP_PK.Value * KPYR_PK.Value / KPEP_PK.Value / KADP_PK.Value / KeqPK.Value";
        }
...
#		 Expression "(VPK_maxf * PEP.getValue() * ADP.getValue() /(KPK_PEP * KPK_ADP) - VPK_maxr * PYR.getValue() * ATP.getValue() / (KPK_PYR * KPK_ATP))/(1 + PEP.getValue() / KPK_PEP + ADP.getValue() / KPK_ADP + PEP.getValue() * ADP.getValue() /(KPK_PEP * KPK_ADP) + PYR.getValue() / KPK_PYR + ATP.getValue() / KPK_ATP + PYR.getValue() * ATP.getValue() / (KPK_PYR * KPK_ATP))";
		 Expression "(Vmaxf_PK.Value * PEP.Value * ADP.Value /(KPEP_PK.Value * KADP_PK.Value) - Vmaxr_PK.Value * PYR.Value * ATP.Value / (KPYR_PK.Value * KATP_PK.Value))/(1.0 + PEP.Value / KPEP_PK.Value + ADP.Value / KADP_PK.Value + PEP.Value * ADP.Value /(KPEP_PK.Value * KADP_PK.Value) + PYR.Value / KPYR_PK.Value + ATP.Value / KATP_PK.Value + PYR.Value * ATP.Value / (KPYR_PK.Value * KATP_PK.Value))";
        }
...
#		Expression  "VLDH_maxf * KLDH_LAC * KLDH_NAD / KLDH_PYR / KLDH_NADH / KLDH_eq";
		Expression  "Vmaxf_LDH.Value * KLAC.Value * KNAD_LDH.Value / KPYR_LDH.Value / KNADH_LDH.Value / KeqLDH.Value";
	}
...
#		Expression "(VLDH_maxf * PYR.getValue() * NADH.getValue() / (KLDH_PYR * KLDH_NADH) - VLDH_maxr * LAC.getValue() * NAD.getValue() / (KLDH_LAC * KLDH_NAD))/(1 + PYR.getValue() / KLDH_PYR + NADH.getValue() / KLDH_NADH + PYR.getValue() * NADH.getValue() / (KLDH_PYR * KLDH_NADH) + LAC.getValue() / KLDH_LAC + NAD.getValue() / KLDH_NAD + LAC.getValue() * NAD.getValue() / (KLDH_LAC * KLDH_NAD))";
		Expression "(Vmaxf_LDH.Value * PYR.Value * NADH.Value / (KPYR_LDH.Value * KNADH_LDH.Value) - Vmaxr_LDH.Value * LAC.Value * NAD.Value / (KLAC.Value * KNAD_LDH.Value))/(1.0 + PYR.Value / KPYR_LDH.Value + NADH.Value / KNADH_LDH.Value + PYR.Value * NADH.Value / (KPYR_LDH.Value * KNADH_LDH.Value) + LAC.Value / KLAC.Value + NAD.Value / KNAD_LDH.Value + LAC.Value * NAD.Value / (KLAC.Value * KNAD_LDH.Value))";
	}
...
#		Expression "VCK_maxr * KCK_iATP * KCK_Cr * KCK_eq / KCK_iADP / KCK_PCr";	
		Expression "Vmaxr_CK.Value * KiATP_CK.Value * KCr.Value * KeqCK.Value / KiADP.Value / KPCr.Value";	
	}
...
#		Expression "(VCK_maxr * ATP.getValue() * Cr.getValue() / (KCK_iATP * KCK_Cr) - VCK_maxf * ADP.getValue() * PCr.getValue() / (KCK_iADP * KCK_PCr))/(1 + ADP.getValue() / KCK_iADP + PCr.getValue() / KCK_iPCr + ADP.getValue() * PCr.getValue() / (KCK_iADP * KCK_PCr) + ATP.getValue() / KCK_iATP + Cr.getValue() / KCK_Cr + ATP.getValue() * Cr.getValue() / (KCK_iATP * KCK_Cr))";
		Expression "(Vmaxr_CK.Value * ATP.Value * Cr.Value / (KiATP_CK.Value * KCr.Value) - Vmaxf_CK.Value * ADP.Value * PCr.Value / (KiADP.Value * KPCr.Value))/(1.0 + ADP.Value / KiADP.Value + PCr.Value / KiPCr.Value + ADP.Value * PCr.Value / (KiADP.Value * KPCr.Value) + ATP.Value / KiATP_CK.Value + Cr.Value / KCr.Value + ATP.Value * Cr.Value / (KiATP_CK.Value * KCr.Value))";
	}
